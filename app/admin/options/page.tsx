  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-black dark:text-white">Options CRUD</h1>
          <p className="mt-2 text-zinc-600 dark:text-zinc-300">Manage options inside sections.</p>
        </div>
