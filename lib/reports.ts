...
/** Une ligne par (jour, frais) ou (jour, caution pour dépenses). */
...
/** Agrégation mensuelle par frais (ou caution). */
...
const WALLET_ROW_CODE = "caution";
const WALLET_ROW_NAME = "Dépenses caution";
